...
% part II: control by decision mode. 
    ...
    for k = num_symt(j)+1:num_symt(j)+num_symd % Ã‰ nessessario esperar um momento (amostras) atÃ© fazer a comparaÃ§Ã£o com o sinal (SeÃ§Ã£o 2.10.4 pag.57 Diniz) . Nesse caso 7 ou 8(metade do comprimento do filtro), pois tem comprimento 15.
        inp = [x(k); init];
        init = inp(1:end-1);
